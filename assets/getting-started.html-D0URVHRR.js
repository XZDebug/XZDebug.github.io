import{_ as a,c as l,f as i,a as r,e as s,b as t,d,r as c,o as p}from"./app-BB7JJvpV.js";const o={};function u(m,n){const e=c("RouteLink");return p(),l("div",null,[n[3]||(n[3]=i(`<h1 id="安装指南" tabindex="-1"><a class="header-anchor" href="#安装指南"><span>安装指南</span></a></h1><h2 id="安装插件" tabindex="-1"><a class="header-anchor" href="#安装插件"><span>安装插件</span></a></h2><h3 id="mcdr-快捷安装" tabindex="-1"><a class="header-anchor" href="#mcdr-快捷安装"><span>MCDR 快捷安装</span></a></h3><ul><li>在已经开启的 MCDReforged MC 服务端输入以下指令可快捷安装插件及前置：<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">!!MCDR plugin install gugubot</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12)),r("p",null,[n[1]||(n[1]=s("上述配置为必要项。如果需要更深入的自定义体验，请阅读完整的")),t(e,{to:"/PF-gugubot/config/config.html"},{default:d(()=>n[0]||(n[0]=[s("配置文档")])),_:1}),n[2]||(n[2]=s("。"))])])}const g=a(o,[["render",u],["__file","getting-started.html.vue"]]),b=JSON.parse('{"path":"/PF-gugubot/guide/getting-started.html","title":"安装指南","lang":"zh-CN","frontmatter":{},"headers":[{"level":2,"title":"安装插件","slug":"安装插件","link":"#安装插件","children":[{"level":3,"title":"MCDR 快捷安装","slug":"mcdr-快捷安装","link":"#mcdr-快捷安装","children":[]},{"level":3,"title":"手动下载安装","slug":"手动下载安装","link":"#手动下载安装","children":[]}]},{"level":2,"title":"配置文件","slug":"配置文件","link":"#配置文件","children":[]}],"git":{"updatedTime":1736565725000,"contributors":[{"name":"Dreamwxz","username":"Dreamwxz","email":"82244600+Dreamwxz@users.noreply.github.com","commits":10,"url":"https://github.com/Dreamwxz"}]},"filePathRelative":"PF-gugubot/guide/getting-started.md"}');export{g as comp,b as data};
